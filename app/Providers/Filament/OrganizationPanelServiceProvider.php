...
class OrganizationPanelServiceProvider extends PanelProvider
{
    ...
    private function configureDiscovery(Panel $panel): self
    {
        $panel
            ...
            ->discoverClusters(in: app_path('Filament/Organization/Clusters'), for: 'App\\Filament\\Organization\\Clusters')
