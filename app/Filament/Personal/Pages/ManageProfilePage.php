...
class ManageProfilePage extends Page implements HasSchemas
{
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                Flex::make([
                    $this->getAvatarFieldSet(),
                    $this->getPersonalInformationFieldSet(),
                ])->from('sm'),
            ])->statePath('data');
    }

    protected function getAvatarFieldSet(): Fieldset
    {
    ...
    protected function getPersonalInformationFieldSet(): Fieldset
    {
        return Fieldset::make()
            ->contained(false)
            ->columns(1)
            ->schema([
                ...
                $this->getAdditionalContactInformationSection(),
                $this->getMilitaryInformationSection(),
            ])->grow(true);
    }
    ...
    protected function getAdditionalContactInformationSection(): Section
    {
        return Section::make('Additional Contact Information')
            ->columns(2)
            ->collapsible()
            ->collapsed(true)
            ->schema([
    ...
    protected function getMilitaryInformationSection(): Section
    {
        return Section::make('Military Information')
            ->columns(2)
            ->collapsible()
            ->collapsed(true)
            ->schema([
